...
<?php
$sql1 = "SELECT * FROM `train` WHERE trainFrom = '$given_from' AND trainTo = '$given_to' AND trainDate = '$given_date'";
...
{ ?>
  ...
  <?php
  $sql = "SELECT * FROM `train` WHERE trainFrom = '$given_from' AND trainTo = '$given_to' AND trainDate = '$given_date'";
  ...
  { ?>
    <div class=" search_train_col">
      <div class="card-body search_train_card" style="border:1px solid;">
        ...
        <a href="booking.php?id=<?php echo $data['trainNumber'] ?>&exist=not" class="btn btn-primary">Book</a>
      </div>
    </div>
