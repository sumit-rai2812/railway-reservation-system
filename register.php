  ...
  $existrow = mysqli_num_rows($result);
      ...
      else
      {
        if($user_pass == $user_cpass)
        {
          ...
          $sql = "INSERT INTO `registration` (`userName`, `userEmail`, `userDOB`, `userGender`, `userMob`, `userAdd`, `userPass`) VALUES ('$user_name', '$user_email', '$user_date_of_birth', '$user_gender', '$user_mob', '$user_add', '$user_pass')";
      ...
      <div class="row login_row">
        ...
        <div class="col-lg-7 admin_login_box">
          <form action="register.php" method="post">
            ...
            <div class="row">
              <div class="col-lg-4">
                <input class="register_input" type="text" name="user_date_of_birth" class="form-control" placeholder="Date of Birth" onfocus="(this.type='date')" required>
